(function ($) {
   ...
   $("[data-appear-animation]").each(function() {
    ...
    /* Header Resize
    /* ====================================== */
    var pbmit_header_expand = function() {
      if(  $('.header-style-2').length>0 ){
        //var this_ele    =  $(this);
        var main_width  =  $('.site-header').width();
        var cont_width  =  $('.pbmit-header-overlay > .container').width();	
			
        var extra_width = ((main_width - cont_width)/2);
        var extra_width_2 =  - Math.abs(extra_width)
         

         $('.header-style-2 .pbmit-expand-header').css({ 'right': extra_width_2+'px', 'width': extra_width+'px'});
      }
    }
